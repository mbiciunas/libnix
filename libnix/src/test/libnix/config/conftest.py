import pytest
from libnix.src.test.libnix.setup.setup_config_empty import SetupConfigEmpty
from libnix.src.test.libnix.setup.setup_config_valid import SetupConfigValid

from test.libnix.setup.setup_config import SetupConfig
